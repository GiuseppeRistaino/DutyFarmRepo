...
<em>dutyfarmsmartedit/web/features/dutyfarmsmarteditContainer/dutyfarmsmarteditcontainermodule.ts</em>
```ts
...
export class DutyfarmsmarteditContainer {}
```
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the dutyfarmsmartedit:
- <em>dutyfarmsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>dutyfarmsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'dutyfarmsmartedit' layer of dutyfarmsmartedit is a bundle of dutyfarmsmartedit and dutyfarmsmarteditcommons.
The 'dutyfarmsmarteditContainer' layer of dutyfarmsmartedit is a bundle of dutyfarmsmarteditContainer and dutyfarmsmarteditcommons.
