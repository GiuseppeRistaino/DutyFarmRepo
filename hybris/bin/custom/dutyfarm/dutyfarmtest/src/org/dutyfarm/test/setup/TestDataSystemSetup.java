 ...
 */
package org.dutyfarm.test.setup;
...
import org.dutyfarm.test.constants.DutyfarmTestConstants;
import org.dutyfarm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DutyfarmTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/dutyfarmtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/dutyfarmtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/dutyfarmtest/import/cstickets.impex");
			...
			importImpexFile(context, "/dutyfarmtest/import/csquotes.impex");
		}
	}
}
