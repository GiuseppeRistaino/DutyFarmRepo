 ...
 */
package org.dutyfarm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(DutyfarmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DutyfarmFulfilmentProcessConstants.PARENT_PROCESS);
