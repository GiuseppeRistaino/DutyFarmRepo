 ...
 */
package org.dutyfarm.core.constants;

/**
 * Global class for all DutyfarmCore constants. You can add global constants for your extension into this class.
 */
public final class DutyfarmCoreConstants extends GeneratedDutyfarmCoreConstants
{
	public static final String EXTENSIONNAME = "dutyfarmcore";


	private DutyfarmCoreConstants()
	{
		//empty
	}
